...
const Task: React.FC = () => {
  ...
  const fetchTasks = async () => {
    ...
    try {
      const res = await fetch(`https://fullstack-bhatn-backend-413936355529.europe-west1.run.app/api/todo/${params.id}/task`, {
        method: 'GET',
  ...
  const fetchTodo = async () => {
    const token = localStorage.getItem('token');
    try {
      const res = await fetch(`https://fullstack-bhatn-backend-413936355529.europe-west1.run.app/api/todo/${params.id}`, {
        method: 'GET',
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const toggleTaskCompletion = async (taskId: number) => {
    ...
    try {
      const res = await fetch(`https://fullstack-bhatn-backend-413936355529.europe-west1.run.app/api/task/${taskId}`, {
        method: 'PUT',
        headers: {
  ...
  const handleAddTask = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://fullstack-bhatn-backend-413936355529.europe-west1.run.app/api/task`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
